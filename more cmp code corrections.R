...
cabinets[cabinets$party_id.y==1033 & is.na(cabinets$cmp2)==T,  c(3:8,2, 9:175,n)]<-c(manifestos[manifestos$party==93223 & manifestos$edate=='2016-12-11',]  ,93223) #romania
...
cabinets[cabinets$party_id.y==397 & is.na(cabinets$cmp2)==T,  c(3:8,2, 9:175,n)]<-c(manifestos[manifestos$party==21426 & manifestos$edate=='2007-06-10',]   ,21426)#belgium
